...
@RunWith(Suite.class)
@SuiteClasses({ CoordinateTest.class, TestBuildingsParser.class, TestCampusBuildings.class, 
	TestPathsParser.class, CampusModelTest.class, PathComparatorTest.class, TestCampusPaths.class })
