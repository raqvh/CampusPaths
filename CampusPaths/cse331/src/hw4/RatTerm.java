  ...
  */
  public RatTerm negate() {
    if(this.isNaN()) {
      ...
      RatTerm result = new RatTerm(coeff.negate(), expt);
      return result;
    }
  }
  ...
  */
  public RatTerm add(RatTerm arg) {
    if(this.isNaN() || arg.isNaN()) {
      ...
      RatTerm result;
      if(this.isZero()) {
        result = new RatTerm(this.coeff.add(arg.coeff), arg.expt);
      } else {
        result = new RatTerm(this.coeff.add(arg.coeff), this.expt);
      }
      return result;
    }
  }
  ...
  public RatTerm differentiate() {
    if(this.isNaN()) {
      ...
      if(this.isZero()) {
        ...
        RatNum b = new RatNum(this.expt);
        RatTerm result = new RatTerm(this.coeff.mul(b), this.expt - 1);
        return result;
      }
    }
  }
  ...
  */
  public RatTerm antiDifferentiate() {
    if(this.isNaN()) {
      ...
      RatNum b = new RatNum(this.expt+1);
      RatTerm result = new RatTerm(this.coeff.div(b), this.expt + 1);
      return result;
    }
  }
